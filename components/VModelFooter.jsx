    ...
    <>
      <VMContainer autoHeight={true} bgSec={false}>
        <section
          className={`${
            !noPadd ? "pt-[2%]" : ""
          } pb-[6%] vm-bg contain gap-12 md:gap-0`}
        >
          <div className="lg:py-[100px] pb-6 lg:pb-0 flex mb-9 relative flex-col md:flex-row">
            <div className="md:w-[45%] flex flex-col justify-between pr-[10%]">
